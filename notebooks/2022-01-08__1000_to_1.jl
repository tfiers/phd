...
set(ax1; ytickstyle=:range, xlabel="Input firing rate", hylabel="Probability density")
set(ax2; ytickstyle=:range, xlabel="(log scale)")
set(ax3; hylabel="Cumulative probability", legend=(:loc=>"lower left", :bbox_to_anchor=>(0.5, 0.02)))
ax3.axhline(0.5, color=toRGBAtuple(lightgrey), zorder=1, lw=1)
