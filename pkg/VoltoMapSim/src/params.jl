...
@kwdef struct Nto1InputParams <: ParamSet
    N_unconn      ::Int             = 100
    N_conn        ::Int             = 6500
...
@kwdef struct NetworkParams <: ParamSet
    N             ::Int           = 1000
    EI_ratio      ::Float64       = 4 / 1
...
@kwdef struct SynapseParams <: ParamSet
...
@kwdef struct IzhikevichParams <: ParamSet
...
@kwdef struct VoltageImagingParams <: ParamSet
...
@kwdef struct GeneralSimParams <: ParamSet
...
@kwdef struct ConnTestParams <: ParamSet
...
@kwdef struct ExperimentParams <: ParamSet
    sim         ::SimParams
