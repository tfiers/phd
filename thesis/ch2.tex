...
To numerically simulate the model described in this chapter, different software implementations have been used throughout the PhD. One of these was an written using the Brian simulator\cite{Stimberg2019BrianIntuitiveEfficient}. Another was a custom software in the Julia language.\cite{Bezanson2017JuliaFreshApproach}.
After a comparison of compilation and runtimes of both implementations (\cref{tab:software-timings}), we decided to use the software written in Julia.\footnoteatfoot{
