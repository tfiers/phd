...
Our neuron model  (\cref{sec:model-summary}) consists of (1) continuous differential equations, and (2) a discontinuous, instantaneous jump (namely whenever $V$ crosses the spike-definition threshold $θ$).
...
Real neurons generally do not show such variability: their spike heights are quite consistent (remarkably so).
For realism

% so, We ceil our spiketimes.
