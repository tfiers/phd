...
\marginpar{
    ...
    \captionof{figure}{
        ...
        \small{using two single spikes arriving at $t = 10$~ms, with synaptic weight of either $Δg_\exc = 14$~pS, or $Δg_\inh = 56$~pS. Parameters as in \cref{tab:AdEx-params}, with $E_\exc = 0$~mV, $E_\inh = -80$~mV and $τ_g = 7$~ms. For the inhibitory impulse response, $g_\exc ≡ 0$, and for the excitatory impulse response, $g_\inh ≡ 0$ (not shown).
