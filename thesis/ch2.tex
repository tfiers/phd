...
\begin{figure}
    \begin{sidecaption}
        ...
        \small{Example signal traces, in the N-to-1 setup, with $N = 6500$ EI-balanced input spiketrains, and $Δg_\exc = 15$~pS. Neuron parameters for a cortical regular spiking neuron.\\
