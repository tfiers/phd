...
\begin{figure}
    ...
    \captionn
        { }
        {}
    \label{fig:perfmeasures_threshold_PPVs_EI}
\end{figure}
...
\begin{figure}
    \begin{sidecaption}
        ...
        For every SNR value, five different simulations were run (gray dots), each with a different RNG seed (and thus different input firing rates and spiketrains). The mean performances of these five simulations are plotted with larger dots and are line-connected.
        ...
        Chance level determined as in \cref{fig:AUC_chance_level}.}
