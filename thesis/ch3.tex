...
%     \begin{sidecaption}
%         {
%             \textbf{Example STA}. An STA of a (high-firing) inhibitory input to an AdEx neuron with 6500 inputs, simulated for 10 minutes.
%             Note the opposite-polarity bump (peaking around $t = 35$~ms) being larger than the IPSP itself (the downwards bump at $t ≈ 5$~ms).
%             Source: \nburl{2023-04-11__Nto1_AdEx_conntest_methods_comparison}.
%         }
%         [fig:STA-longwin-high-N]
%         \hspace*{2em}
%         \includegraphics[w=0.9]{STA-longwin-high-N.png}
%     \end{sidecaption}
% \end{figure}
%
% this stuff is in fig 20 example sta's already; with positive sta.
    ...
    \begin{sidecaption}
        {
            ...
            Source: \nburl{2024-05-29__STA-winlength}.
        }
        [fig:perf-STA-winlength]
        \includegraphics[w=1.03]{perf-STA-winlength.pdf}
    \end{sidecaption}
\end{figure}
...
Why does the shorter window length ($20$~ms versus $100$~ms) lead to such a strong increase in detection performance?
