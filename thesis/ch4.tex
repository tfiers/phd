...
\Cref{fig:N_sweep__AUC__upstroke_vs_STA} shows the performance of this linear regression method, for different number of inputs $N$, and compared to the STA height method.
