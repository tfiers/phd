...
% https://tex.stackexchange.com/questions/284486/set-a-different-layout-for-a-single-page-in-memoir
...
% I want to thank the following people for helping to make this thesis a reality.
...
% Lucia, Sara, Steven, Pieter, Silke, my parents, my friends in Holsbeek (Emily, Lies, Tim, Arnoud, Katia) and in Nottingham (Frederica, Helen, Emily).
